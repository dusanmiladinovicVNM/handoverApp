...
function verifyDeployment() {
  const SERVICES = [
    ...
    ['AttachmentService', () => AttachmentService, ['uploadAttachment', 'deleteAttachment',
      'getSectionThumbs', 'getAttachmentFile']],
    ['SignatureService', () => SignatureService, ['saveSignature']],
    ['PdfService', () => PdfService, ['finalizeInspection', 'downloadPdf']],
    ['DriveService', () => DriveService, ['createInspectionFolders', 'getThumbnailBytes', 'getFileBytes',
  ...
  const EXPECTED_ACTIONS = [
    ...
    'uploadAttachment', 'deleteAttachment', 'getSectionThumbs', 'getAttachmentFile',
