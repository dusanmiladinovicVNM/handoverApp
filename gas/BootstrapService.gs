...
function verifyDeployment() {
  const SERVICES = [
    ...
    ['AttachmentService', () => AttachmentService, ['uploadAttachment', 'deleteAttachment', 'getSectionThumbs']],
    ['SignatureService', () => SignatureService, ['saveSignature']],
    ['PdfService', () => PdfService, ['finalizeInspection', 'downloadPdf']],
    ['DriveService', () => DriveService, ['createInspectionFolders', 'getThumbnailBytes',
  ...
  const EXPECTED_ACTIONS = [
    ...
    'uploadAttachment', 'deleteAttachment', 'getSectionThumbs',
