...
const APP_SHELL = [
  ...
  './js/utils/store.js',
  './js/utils/drafts.js',
  './js/utils/pending-saves.js',
  './js/utils/thumbs.js',
  './js/photo-viewer.js',
  './js/utils/inspection-cache.js',
  './css/fonts.css',
  './assets/fonts/pt-sans-400-latin.woff2',
  './assets/fonts/pt-sans-400-latin-ext.woff2',
  './assets/fonts/pt-sans-700-latin.woff2',
  './assets/fonts/pt-sans-700-latin-ext.woff2',
  './assets/logo/cpmh-real-estate.svg',
